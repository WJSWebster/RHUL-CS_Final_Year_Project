...
class Rocket(pygame.sprite.Sprite):
    def __init__(self, owner, target, angle, damage):  #damage could probably be gotten from rocketTurret global
    ...
    def rotate(self):
        #pygame.transform.rotate(surface?, angle)  #https://www.pygame.org/docs/ref/transform.html#pygame.transform.rotate
        self.angle = (self.target.x - self.x, self.target.y - self.y)  # https://docs.python.org/2/library/math.html#math.atan2
